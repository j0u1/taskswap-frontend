...
<template>
    <aside class="h-screen flex flex-col gap-4 w-2/12 duration-300 transition-all" :class="{ 'w-21': isCollapsed }">
        ...
        <div class="space-y-3.5 px-3">
            <NuxtLink
                ...
                :key="page.title"
                :to="page.path"
                class="flex items-center gap-2 text-gray outline outline-additional rounded-lg py-2 px-2.5 font-medium duration-300 transition-all whitespace-nowrap relative"
                :class="[
